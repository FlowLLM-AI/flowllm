...
async def async_main():
    ...
    async with FlowLLMApp():
        # Test 1: Test with query parameter
        print("=" * 80)
        ...
        # Test 2: Test with messages parameter
        print("=" * 80)
        ...
        # Test 3: Test format_messages utility function
        print("=" * 80)
        ...
        assert "user: Hello".lower() in formatted.lower(), f"Formatted messages should contain user message. formatted={formatted}"
        assert "assistant: Hi there!".lower() in formatted.lower(), f"Formatted messages should contain assistant message. formatted={formatted}"
        print("✓ Test 3 passed\n")
        
        # Test 4: Test with empty query and empty messages (should raise assertion error)
        print("=" * 80)
        ...
        # Test 5: Test with technical query
        print("=" * 80)
